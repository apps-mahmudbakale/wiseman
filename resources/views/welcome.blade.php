...
<head>
    ...
    <title>WiseMan Collection- Home of Fashion</title>

    <meta name="keywords" content="WiseMan Collections" />
    <meta name="description" content="WiseMan Collection- Home of Fashion">
            ...
            <div class="container">
                <div class="header-left">
                    ...
                    <a href="demo3.html" class="logo">
                        <img src="assets/logo.png" alt="Porto Logo">
                    </a>
    ...
    <main class="main">
        <div class="home-slider slide-animate owl-carousel owl-theme show-nav-hover nav-big">
            <div class="home-slide home-slide1 banner d-flex align-items-center">
                <img class="slide-bg" src="assets/banner-7.png"
            ...
            <div class="home-slide home-slide2 banner d-flex align-items-center">
                <img class="slide-bg" src="assets/banner-8.png"
            ...
            <div class="home-slide home-slide2 banner d-flex align-items-center">
                <img class="slide-bg" src="assets/banner-9.png"
                     style="background-color: #bfcec9;" alt="home banner">
                <div class="banner-layer appear-animate" data-animation-name="fadeInUpShorter">
                    <h2>New Season Hats </h2>
                    <h3 class="text-uppercase rotated-upto-text mb-0"><small>Up to</small>20% off</h3>
        ...
        <section class="container">
            ...
            <div class="owl-carousel owl-theme nav-image-center show-nav-hover nav-outer cats-slider appear-animate"
                ...
                <div class="product-category">
                    <a href="demo3-shop.html">
                        <figure>
                            <img src="assets/images/demoes/demo3/categories/category-2.jpg" width="273" height="273"
                                 alt="category" />
                        </figure>
                        <div class="category-content">
                            <h3>Bags</h3>
                ...
                <div class="product-category">
                    <a href="demo3-shop.html">
                        <figure>
                            <img src="assets/images/demoes/demo3/categories/category-3.jpg" width="273" height="273"
                                 alt="category" />
                        </figure>
                        <div class="category-content">
                            <h3>Electronics</h3>
                ...
                <div class="product-category">
                    <a href="demo3-shop.html">
                        <figure>
                            <img src="assets/images/demoes/demo3/categories/category-4.jpg" width="273" height="273"
                                 alt="category" />
                        </figure>
                        <div class="category-content">
                            <h3>Fashion</h3>
                ...
                <div class="product-category">
                    <a href="demo3-shop.html">
                        <figure>
                            <img src="assets/images/demoes/demo3/categories/category-5.jpg" width="273" height="273"
                                 alt="category" />
                        </figure>
                        <div class="category-content">
                            <h3>Headphone</h3>
                ...
                <div class="product-category">
                    <a href="demo3-shop.html">
                        <figure>
                            <img src="assets/images/demoes/demo3/categories/category-6.jpg" width="273" height="273"
                                 alt="category" />
                        </figure>
                        <div class="category-content">
                            <h3>Shoes</h3>
